...
**Tests**: Per the Infinity Alpha Constitution, NO tests are included in this project. Manual verification by developers is the only validation method. Any task template references to testing should be removed.
...
<!-- 
  ...
  PER CONSTITUTION: Test tasks MUST NOT be included. Manual testing is developer responsibility.
...
- [ ] T004 [P] Setup Python virtual environment configuration (.venv, requirements.txt)
...
**Constitution Compliance**: Ensure all foundational components follow Clean Code and Responsive Design principles (for frontend). No automated testing setup is required.
...
**Manual Verification Steps**: [How to manually verify this story works on its own]
...
- [ ] T015 [US1] Add validation and error handling per Clean Code principle
...
- [ ] TXXX Code cleanup and refactoring per Clean Code principle
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX [P] Manual verification pass: verify all user stories work independently
...
- Models before services (Constitution forbids automated tests)
